...
const dto_validation_exception_1 = require("../exception/models/dto-validation.exception");
let DtoValidationPipe = class DtoValidationPipe {
    async transform(value, { type, metatype }) {
        ...
        if (errors.length > 0) {
            throw new dto_validation_exception_1.DtoValidationException(errors, type);
        }
        return object;
    }
    toValidate(metatype) {
